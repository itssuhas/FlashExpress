    ...
    <section class="content-header">
     ...
     <b>Banner Deatils</b>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Banner Deatils</li>
        </ol>
    </section>
            ...
            <div class="box-body">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <button class="btn btn-success pull-right" data-toggle="modal" data-target="#addRetailer">Add Banner</button>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                     ...
                                     @php($i=1)
                                      @foreach($retailer as $item)
                                        <tr>
                                        <td>{{$i++}}</td>
                                        <td><img style="width:100px; height:100px;" src="<?php echo asset("images/banner/$item->image")?>"></img></td>
                                  
                                       <td>
                                        <a href="{{URL::to('bannerdelete/'.$item->id) }}">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="banner_deatils" method="post" id="retailerreg" name="retailerreg" enctype="multipart/form-data">
