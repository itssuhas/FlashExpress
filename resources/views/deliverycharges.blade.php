        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            <button class="btn btn-success pull-right" data-toggle="modal" data-target="#addRetailer">Add Delivery Charge</button>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                     ...
                                     @php($i=1)
                                      @foreach($retailer as $item)
                                       ...
                                       <td>
                                        <a href="{{URL::to('deliveryChargesdelete/'.$item->id) }}">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="charges_deatils" method="post" id="retailerreg" name="retailerreg" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="box-body">
                            
                            <div class="row">
                                <div class="col-md-12  charges_range  {{($errors->has('charges_range'))?'has-error':''}}">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Charges Range</label>
                            <select name="charges_range" class="form-control">
                            <option>200</option>
                            <option>250</option>
                            <option>500</option>
                            </select>
                                        @if ($errors->has('charges_range'))
                                            <small class="help-block">
                                                {{ $errors->first('charges_range') }}
                                            </small>
                                        @endif

                                    </div>
                                </div>
                                <div class="col-md-12  charges  {{($errors->has('charges'))?'has-error':''}}">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"> Charges</label>
                                        <input type="text" value="{{old('charges')}}"
                                         name="charges" class="form-control"
                                               id="charges" placeholder="Enter Charges">
                ...
                .formValidation({
                    ...
                    fields: {
                        ...
                        charges_range: {
                            validators: {
                                notEmpty: {
                                    message: 'charges range is required'
                                }
                            }
                        },
