    ...
    <section class="content-header">
     ...
     <b>Items Deatils</b>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Items Deatils</li>
        </ol>
    </section>
                    ...
                    @if(isset($retailer))
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-bordered table-hover retailer-search">
                                    ...
                                    <tr>
                                     ...
                                     @php($i=1)
                                      @foreach($retailer as $item)
                                        ...
                                        <td>{{$item->item_discount_amt}}
                                        </td>
                                        <td>{{$item->item_half_price}}</td>
                                        <td>{{$item->item_half_discount_amt}}</td>
                                        <td>{{$item->qty_type}}</td>
                                  ...
                                  <td> 
                                   <a href="{{URL::to('itemupdate/'.$item->item_id) }}">
                                   ...
                                   <a href="{{URL::to('blockItem/'.$item->item_id) }}">
                                       <span class="glyphicon glyphicon-ok"  onclick="return confirm('Are you sure......?')">
                                          Block
                                       </span> </a>
                                       @endif
                                    @if($item->status == 'block')
                                    <a href="{{URL::to('unblockItem/'.$item->item_id) }}">
                                       <span class="glyphicon glyphicon-ok"  onclick="return confirm('Are you sure......?')">
                                          UnBlock
                                       </span> </a>
                                    @endif
                                       ...
                                       <td>
                                        <a href="{{URL::to('itemdelete/'.$item->item_id) }}">
                        ...
                        @endforeach  
                            ...
                            <div class="row">
                                <div class="col-md-6  item_price {{($errors->has('item_price'))?'has-error':''}}">
                                    <div class="form-group">
                                        ...
                                        <input type="textbox" value="{{old('item_price')}}"
                                ...
                                <div class="col-md-6  item_discount_amt {{($errors->has(' item_discount_amt'))?'has-error':''}}">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Item Discount Amount
                                        <input type="text" value="{{old('item_discount_amt')}}"
                                         name="item_discount_amt" class="form-control"
                                               id="item_discount_amt" placeholder="Enter discount amount">
                            ...
                            <div class="row">
                                <div class="col-md-6  item_half_price {{($errors->has('item_half_price'))?'has-error':''}}">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Item Half Price
                                        <input type="textbox" value="{{old('item_half_price')}}"
                                ...
                                <div class="col-md-6  item_half_discount_amt {{($errors->has(' item_half_discount_amt'))?'has-error':''}}">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Item  Half Discount Amount
                                        <input type="text" value="{{old('item_half_discount_amt')}}"
                                         name="item_half_discount_amt" class="form-control"
                                               id="item_half_discount_amt" placeholder="Enter Half discount amount">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 image {{($errors->has('image'))?'has-error':''}}">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">image(Dimensions:- 500*500)
                            ...
                            <div class="row">
                                <div class="col-md-12 qty_type {{($errors->has('qty_type'))?'has-error':''}}">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Qty Type</label>
                        <select name="qty_type[]" class="form-control" multiple="multiple">
                        <option>Full</option>                       
                        <option>Half</option>
                        <option>None</option>
                ...
                .formValidation({
                    ...
                    fields: {
                        ...
                        item_half_discount_amt: {
                            validators: {
                                notEmpty: {
                                    message: 'item half discount price is required'
                                }
                            }
                        },
