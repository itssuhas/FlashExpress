    ...
    <section class="content-header">
     ...
     <b>Admin Information</b>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Admin Deatils</li>
        </ol>
    </section>
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            <button class="btn btn-success pull-right" data-toggle="modal" data-target="#addRetailer">Add Admin</button>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                     ...
                                     @php($i=1)
                                      @foreach($retailer as $item)
                                        ...
                                        <td>{{$item->address}}</td>
                                        <td>
                                            <a href="{{URL::to('admindelete/'.$item->id) }}">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="admin_deatils" method="post" id="retailerreg" name="retailerreg" enctype="multipart/form-data">
