    ...
    <section class="content-header">
     ...
     <b>City Deatils</b>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">City Deatils</li>
        </ol>
    </section>
            ...
            <div class="box-body">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <button class="btn btn-success pull-right" data-toggle="modal" data-target="#addRetailer">Add City</button>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                     ...
                                     @php($i=1)
                                      @foreach($retailer as $item)
                                        ...
                                        <td>                               <a href="{{URL::to('cityupdate/'.$item->city_id) }}">
                                       <span class="glyphicon glyphicon-edit">
                                          Update
                                       </span> </a></td>
                                       <td>
                                        <a href="{{URL::to('citydelete/'.$item->city_id) }}">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="city_deatils" method="post" id="retailerreg" name="retailerreg" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="box-body">
                            
                            <div class="row">
                                <div class="col-md-12  city_name  {{($errors->has('city_name'))?'has-error':''}}">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">City Name</label>
                                        <input type="text" value="{{old('city_name')}}"
