...
@section('page-content')
    ...
    <section class="content-header">
        <h1>
     <b>Restaurants Category Deatils</b>
        </h1>
        <ol class="breadcrumb">
            <li><a href="/dashboard"><i class="fa fa-dashboard"></i>Home
            </a></li>
            <li class="active">Restaurants Category</li>
        </ol>
    </section>  
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            <button class="btn btn-success pull-right" data-toggle="modal" data-target="#addRetailer">Add Resto Category</button>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                     ...
                                     @php($i=1)
                                      @foreach($retailer as $item)
                                        ...
                                        <td><img style="width:100px; height:100px;" src="<?php echo asset("../images/category/$item->image")?>"></img></td>
                                        
                                        <td>
                                    <a href="{{URL::to('restocatupdate/'.$item->id) }}">
                                       ...
                                       <td>
                                        <a href="{{URL::to('Restocatdelete/'.$item->id) }}">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add  Resto Category</h4>
                </div>
                <div class="modal-body">
                    <form action="restocat_deatils" method="post" id="retailerreg" name="retailerreg" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="box-body">
                            
                            <div class="row">
                                <div class="col-md-12  bussiness_id  {{($errors->has('bussiness_id'))?'has-error':''}}">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Bussiness Name</label>
                                         <select name="bussiness_id" class="form-control">
                        
                          @foreach($bussinesslist as $user)
                            <option value="{{$user->id}}">{{$user->cat_name}}</option>
                        @endforeach                                            


                                        </select>
                                        @if ($errors->has('bussiness_id'))
                                            <small class="help-block">
                                                {{ $errors->first('bussiness_id') }}
                                            </small>
                                        @endif
                                ...
                                <div class="col-md-12  res_cat_name  {{($errors->has('res_cat_name'))?'has-error':''}}">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Restaurant Category</label>
                                        <input type="text" value="{{old('res_cat_name')}}"
                                         name="res_cat_name" class="form-control"
                                               id="res_cat_name" placeholder="Enter Res Category Name">
                ...
                .formValidation({
                    ...
                    fields: {
                        ...
                        res_cat_name: {
                            validators: {
                                notEmpty: {
                                    message: 'Restaurant cat name is required'
                                }
                            }
                        },
                        image: {
