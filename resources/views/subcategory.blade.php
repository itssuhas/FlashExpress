                                    ...
                                    <tr>
                                     ...
                                     @php($i=1)
                                      @foreach($retailer as $item)
                                        ...
                                        <td>                       <a href="{{URL::to('subcategoryupdate/'.$item->id) }}">
                                       <span class="glyphicon glyphicon-edit">
                                          Update
                                       </span> </a></td>
                                       <td>
                                        <a href="{{URL::to('subcatdelete/'.$item->id) }}">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="subcat_deatils" method="post" id="retailerreg" name="retailerreg" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="box-body">
                            
                            <div class="row">
                                <div class="col-md-6  cat_id  {{($errors->has('cat_id'))?'has-error':''}}">
                        ...
                        @endforeach                                            
                                ...
                                <div class="col-md-6  subcat_name  {{($errors->has('subcat_name'))?'has-error':''}}">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Sub Category Name</label>
                                        <input type="text" value="{{old('subcat_name')}}"
                                         name="subcat_name" class="form-control"
