...
@section('page-content')
    ...
    <section class="content-header">
        <h1>
     <b>Ecommorce Bussiness</b>
        </h1>
        <ol class="breadcrumb">
            <li><a href="/dashboard"><i class="fa fa-dashboard"></i>Home</a></li>
            <li class="active">Ecommorce Bussiness</li>
        </ol>
    </section>
            ...
            <div class="box-body">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <button class="btn btn-success pull-right" data-toggle="modal" data-target="#addRetailer">Add Bussiness</button>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                     ...
                                     @php($i=1)
                                      @foreach($retailer as $item)
                                        ...
                                        <td><img style="width:100px; height:100px;" src="<?php echo asset("../images/bussiness/$item->image")?>"></img></td>
                                        <td>
                                       ...
                                       <td>
                                        <a href="{{URL::to('Ecommcatdelete/'.$item->id) }}">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add Bussiness</h4>
                </div>
                <div class="modal-body">
                    <form action="ecommcat_deatils" method="post" id="retailerreg" name="retailerreg" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{old('cat_name')}}"
                                         name="cat_name" class="form-control"
                                               id="cat_name" placeholder="Enter Bussiness Name">
