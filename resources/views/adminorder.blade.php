                    ...
                    @if(isset($retailer))
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-bordered table-hover retailer-search">
                                  ...
                                  <td>                              
                                    <a href="{{URL::to('getAdminOrder/'.$item->order_id) }}">
                                       <span class="glyphicon glyphicon-edit">
                                        View Deatils & Assign Order 
                                       </span> </a></td>
                                <td>                              
                                    <a href="{{URL::to('rejectAdminOrder/'.$item->order_id) }}">
                                       <span class="glyphicon glyphicon-edit"  onclick="return confirm('Are you sure......?')">
                                        Reject Order
                                       </span> </a>
                                   </td>  
                                    <td>
