    ...
    <section class="content">
        ...
        <!-- /.box -->
                ...
                <div class="container">
                    ...
                    <form action='/paymentvendorupdate' method="post" id="retailerreg" name="retailerreg" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="id" id="id" value="{{$values->id}}">
                            ...
                            <div class="col-md-6  payable_amount  {{($errors->has('payable_amount'))?'has-error':''}}">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Payable Amount Vednor</label>
                                    <input type="text" value="{{$values->payable_amount_vendor}}"
                                   ...
                                   <div class="col-md-6  paid_amount  {{($errors->has('paid_amount'))?'has-error':''}}">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Vendor Paid Amount</label>
                                    <input type="text" value="{{$values->paid_amount_vendor}}"
