                                    ...
                                    <tr>
                                     ...
                                     @php($i=1)
                                      @foreach($retailer as $item)
                                        ...
                                        <td>
                                            <a href="{{URL::to('categoryupdate/'.$item->id) }}">
                                       ...
                                       <td>
                                        <a href="{{URL::to('catdelete/'.$item->id) }}">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="cat_deatils" method="post" id="retailerreg" name="retailerreg" enctype="multipart/form-data">
