    ...
    <section class="content">
        ...
        <!-- /.box -->
                ...
                <div class="container">
                    ...
                    <form action='/userupdate' method="post" id="retailerreg" name="retailerreg" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="id" id="id" value="{{$values->id}}">
                            <div class="row">
                                ...
                                <div class="col-md-6  full_name  {{($errors->has('full_name'))?'has-error':''}}">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Full Name</label>
                                    <input type="text" value="{{$values->full_name}}"
                                         name="full_name" class="form-control"
                                               id="full_name" placeholder="Enter Usernmae">
